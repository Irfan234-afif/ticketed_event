  ...
  <div class="flex flex-col gap-8 pb-8">
    ...
    <div>
      ...
      <div class="space-y-3">
        ...
        >
          <div class="flex items-center gap-3">
             ...
             <div class="flex flex-col">
                <span class="font-medium text-gray-900 text-sm">{{ participant.full_name || 'Guest ' + (index + 1) }}</span>
          ...
          <div class="flex items-center gap-2">
             ...
             <Button 
              v-if="store.participants.length > 1" @click="store.removeParticipant(index)" 
              variant="ghost" 
              class="text-gray-400 hover:text-red-500 !p-0" 
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" fill="black" fill-opacity="0.25"/>
        ...
        <!-- Add Guest Button -->
        <button 
           v-if="store.participants.length < 3"
           @click="openAddModal"
       ...
       <p class="mt-4 text-[13px] leading-relaxed text-dark">
          Kamu bisa mendaftarkan maksimal 3 orang (termasuk kamu) menggunakan nomor WhatsAppmu.
       </p>
    </div>
    ...
    <div>
      ...
      <div v-else class="flex flex-col gap-3">
        <button
          ...
          :key="String(date)"
          class="bg-gray-50 w-full py-4 px-6 rounded-xl text-left transition-all text-[15px]"
          :class="[
