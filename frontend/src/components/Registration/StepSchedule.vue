...
<template>
  <div class="flex flex-col gap-6">
    ...
    <!-- Section Header -->
    <div class="mt-4">
      <h3 class="text-lg font-bold text-gray-900">Pick your arrival time</h3>
      <p class="text-gray-600 text-sm mt-1">Kamu bisa memilih 2 slot kedatangan dalam satu hari.</p>
    </div>
